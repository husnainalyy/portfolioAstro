---
title: 🌊 Infinity Waves Inc
publishDate: 2024-02-17 00:00:00
img: /assets/InfinityWave.png
img_alt: A screenshot showcasing the Infinity Waves Inc website, featuring both client and admin interfaces.
description: |
  Infinity Waves Inc is a comprehensive agency website with distinct client and admin interfaces. The client side is dynamic, allowing admins to update FAQs, reviews, skills, and roles. Built as part of the Infinity Wave Solutions internship, this MERN stack project utilizes Tailwind CSS, Bootstrap, Shadcn, UcertaInity UI, Magic Design, Bcrypt, Cloudinary, and Firebase for a robust, scalable solution.
tags:
  - MERN Stack
  - Tailwind CSS
  - Bootstrap
